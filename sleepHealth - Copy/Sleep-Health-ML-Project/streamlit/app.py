...
df = pd.read_csv(r'd:\CODEgeek\sleepHealth\Sleep-Health-ML-Project\.streamlit\Dataset\dataset.csv')
...
if selected == "Prediction":
    ...
    with features:
        ...
        def load_model():
            ...
            """
            with open(r'd:\CODEgeek\sleepHealth-Copy\Sleep-Health-ML-Project\.streamlit\Models\model.pkl', 'rb') as f:
                model = pickle.load(f)
            return model

        gender_le = joblib.load(r'd:\CODEgeek\sleepHealth-Copy\Sleep-Health-ML-Project\.streamlit\Models\gender_encoder.pkl')
        occupation_le = joblib.load(r'd:\CODEgeek\sleepHealth-Copy\Sleep-Health-ML-Project\.streamlit\Models\occupation_encoder.pkl')
        bmiCategory_le = joblib.load(r'd:\CODEgeek\sleepHealth-Copy\Sleep-Health-ML-Project\.streamlit\Models\bmi_category_encoder.pkl')
        sleepDisorder_le = joblib.load(r'd:\CODEgeek\sleepHealth-Copy\Sleep-Health-ML-Project\.streamlit\Models\sleep_disorder_encoder.pkl')
        scaler = joblib.load(r'd:\CODEgeek\sleepHealth-Copy\Sleep-Health-ML-Project\.streamlit\Models\scaler.pkl')
...
if selected == "Contact":
    ...
    html_path = r'd:\CODEgeek\sleepHealth-Copy\Sleep-Health-ML-Project\.streamlit\ContactPage\index.html'
    css_path =r'd:\CODEgeek\sleepHealth-Copy\Sleep-Health-ML-Project\.streamlit\ContactPage\style.css' 
